...
from manushya.core.exceptions import NotFoundError, ValidationError, AuthorizationError
...
class PolicyUpdate(BaseModel):
    rule: Optional[Dict[str, Any]] = Field(None, description="JSON Logic rule")
    description: Optional[str] = Field(None, description="Policy description")
