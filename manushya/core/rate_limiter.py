...
class RateLimiter:
    ...
    def calculate_limit(
        ...
        role_multiplier = RateLimiter.ROLE_LIMITS.get(role_key, RateLimiter.ROLE_LIMITS["default"])
        ...
        if rate_limit:
            ...
            if rate_limit.request_count > actual_limit:
                ...
                return False, {
                    "limit": actual_limit,
                    "remaining": 0,
                    "reset_time": (rate_limit.window_start + timedelta(seconds=window_seconds)).timestamp(),
                    "window_seconds": window_seconds
                }
            ...
            return True, {
                "limit": actual_limit,
                "remaining": remaining,
                "reset_time": (window_start + timedelta(seconds=window_seconds)).timestamp(),
                "window_seconds": window_seconds
            }
