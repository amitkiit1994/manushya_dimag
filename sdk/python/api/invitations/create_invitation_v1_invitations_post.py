...
from ...models.invitation_create import InvitationCreate
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[HTTPValidationError, InvitationResponse]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, InvitationResponse]
    """
