...
from ...models.usage_daily_response import UsageDailyResponse
...
) -> HTTPValidationError | list["UsageDailyResponse"] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = UsageDailyResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | list["UsageDailyResponse"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[HTTPValidationError, list['UsageDailyResponse']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, list['UsageDailyResponse']]
    """
